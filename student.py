...
class Student:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"d:\Users\Anjali\Desktop\Face Recognition System\college_images\face-recognition.png")
        ...
        # second image
        img1=Image.open(r"d:\Users\Anjali\Desktop\Face Recognition System\college_images\smart-attendance.jpg")
        ...
        # third image
        img2=Image.open(r"d:\Users\Anjali\Desktop\Face Recognition System\college_images\iStock.jpg")
        ...
        # backgroung image
        img3=Image.open(r"d:\Users\Anjali\Desktop\Face Recognition System\college_images\wp2551980.jpg")
        ...
        img_left=Image.open(r"d:\Users\Anjali\Desktop\Face Recognition System\college_images\AdobeStock.jpeg")
        ...
        current_course_frame.place(x=5,y=140,width=780,height=115)
        ...
        dep_combo["values"]=("select Department","Computer","Civil","Electronics","IT","Mechanical")
        dep_combo.current(0)
        ...
        class_student_frame.place(x=5,y=260,width=780,height=290)  


        # student ID
        std_id_label=Label(class_student_frame,text="StudentID:",font=("times new roman",13,"bold"))
        ...
        # student name
        std_name_label=Label(class_student_frame,text="Student Name:",font=("times new roman",13,"bold"))
        std_name_label.grid(row=0,column=2,padx=40,pady=5,sticky=W)

        std_name_entry=ttk.Entry(class_student_frame,textvariable=self.var_stdname,width=20,font=("times new roman",13,"bold"))
        ...
        #std_div_entry.grid(row=1,column=1,padx=10,pady=5,sticky=W)
        ...
        roll_no_label.grid(row=1,column=2,padx=40,pady=5,sticky=W)
       ...
       # gender_entry=ttk.Entry(class_student_frame,textvariable=self.var_gender,width=20,font=("times new roman",13,"bold"))
        ...
        dob_label.grid(row=2,column=2,padx=40,pady=5,sticky=W)
        ...
        # Phone no
        phoneno_label=Label(class_student_frame,text="Phone No:",font=("times new roman",13,"bold"))
        phoneno_label.grid(row=3,column=2,padx=40,pady=5,sticky=W)
        ...
        teacher_name_label.grid(row=4,column=2,padx=40,pady=5,sticky=W)
        ...
        btn_frame.place(x=8,y=200,width=750,height=36)
        ...
        btn_frame1.place(x=8,y=235,width=750,height=30)
        
        take_photo_btn=Button(btn_frame1,text="Take Photo Sample",command=self.generate_data,width=37,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        Right_frame.place(x=815,y=10,width=660,height=580)

        img_right=Image.open(r"d:\Users\Anjali\Desktop\Face Recognition System\college_images\student.jpg")
        ...
        table_frame.place(x=5,y=210,width=645,height=300)
        ...
        if self.var_dep.get() == "Select Department" or self.var_stdname.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(
                    host="localhost", username="root", password="Anjali123", database="facerecognitionsystem")
                ...
                ), self.var_stdname.get(), self.var_div.get(), self.var_roll.get(), self.var_gender.get(), self.var_dob.get(), self.var_email.get(), self.var_phone.get(), self.var_address.get(), self.var_teacher.get(), self.var_radio1.get()))
                conn.commit()
                conn.close()
                messagebox.showinfo(
                    "Success", "Student Details has beem aadded sucessfully", parent=self.root)
            ...
            try:
                ...
                if Update>0:
                    conn = mysql.connector.connect(
                        host="localhost", username="root", password="Anjali123", database="facerecognitionsystem")
                    my_cursor = conn.cursor()
                    my_cursor.execute("update student set dep=%s,course=%s,year=%s,sem=%s,name=%s,roll=%s,gender=%s,dob=%s,email=%s,phone=%s,address=%s,teacher=%s,photo=%s where std_id=%s", (self.var_dep.get(), self.var_course.get(), self.var_year.get(
                    ), self.var_semester.get(), self.var_stdname.get(),self.var_roll.get(), self.var_gender.get(), self.var_dob.get(), self.var_email.get(), self.var_phone.get(), self.var_address.get(), self.var_teacher.get(), self.var_radio1.get(), self.var_std_id.get()))
                else:
                    if not Update:
                        return
                messagebox.showinfo(
                    "Sucess", "Student detail update sucessfull", parent=self.root)
                conn.commit()
                self.fetch_data()
                conn.close()
            except Exception as es:
    ...
    def delete_data(self):
        if self.var_std_id.get() == "":
            ...
            try:
                ...
                conn.close()
                messagebox.showinfo(
                    "Delete", "Sucessfully deleted student information", parent=self.root)
            except Exception as es:
                messagebox.showerror(
                    "Error", f"Due to {str(es)}", parent=self.root)
    ...
    #========================Generate datat set OR Take photo Samples==========================
        ...
        if self.var_dep.get() == "Select Department" or self.var_stdname.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                for x in myresult:
                    id += 1
                my_cursor.execute("update student set dep=%s,course=%s,year=%s,sem=%s,name=%s,roll=%s,gender=%s,dob=%s,email=%s,phone=%s,address=%s,teacher=%s,photo=%s where std_id=%s", (self.var_dep.get(), self.var_course.get(), self.var_year.get(
                ), self.var_semester.get(), self.var_stdname.get(), self.var_roll.get(), self.var_gender.get(), self.var_dob.get(), self.var_email.get(), self.var_phone.get(), self.var_address.get(), self.var_teacher.get(), self.var_radio1.get(), self.var_std_id.get() == id+1))
                conn.commit()
                self.fetch_data()
                self.reset_data()
                conn.close()
                ...
                messagebox.showinfo("Result", "Generating Dataset Complted")
