...
class Train:
    def __init__(self,root):
        ...
        b1_btn=Button(self.root,text="TRAIN DATA",command=self.train_classifier,cursor="hand2",font=("times new roman",25,"bold"),bg="red",fg="white")
    ...
    def train_classifier(self):
        ...
        for image in path:
            ...
            # D: \DIP\Attendence_System\data\user.2.1.jpg
